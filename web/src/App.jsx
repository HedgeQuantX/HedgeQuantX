  ...
  return (
    <div className="min-h-screen bg-bg-primary flex flex-col items-center justify-center p-4">
      <div className="text-center animate-fade-in">
        ...
        <h1 className="text-3xl font-bold mb-2" style={{ fontFamily: 'Clonoid, sans-serif' }}><span className="text-accent">HedgeQuant</span><span className="text-pink">𝕏</span></h1>
