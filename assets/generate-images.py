...
def gen_algo():
    ...
    lines = [
        ...
        full_border("╠", "╣", "╧"),
        smart_log("09:31:02", "INFO ", WHITE, "ALGO STARTING... | Rithmic | MNQ"),
        smart_log("09:31:03", "CONN ", GREEN, "CONNECTED | Rithmic Gateway"),
        smart_log("09:31:04", "INFO ", WHITE, "ALGO RUNNING | Scanning for alpha..."),
        smart_log("09:31:15", "INFO ", WHITE, "MARKET OPEN | US SESSION | 09:31 ET"),
        smart_log("09:32:05", "SYS  ", CYAN, "▲ LONG | delta: +245 | buy: 68%"),
        smart_log("09:32:45", "SYS  ", CYAN, "APPROACHING POC | 12/15 ticks to 21,845.25"),
        smart_log("09:33:02", "SYS  ", CYAN, "AT POC ZONE | @ 21,845.25 - checking confirmations..."),
        smart_log("09:33:05", "SYS  ", YELLOW, "POC - 2/3 CONF | delta, pressure"),
        smart_log("09:33:18", "SYS  ", GREEN, "✓ SIGNAL ▲ LONG | POC @ 78% conf | LIMIT"),
        smart_log("09:33:19", "BUY  ", GREEN, "ORDER LIMIT | BUY 1 MNQ @ 21,845.25"),
        smart_log("09:33:20", "BUY  ", GREEN, "✓ FILLED | BUY 1 MNQ @ 21,845.25"),
        smart_log("09:34:45", "WIN  ", GREEN, "POSITION CLOSED | LONG | P&L: +$42.50"),
        smart_log("09:34:46", "INFO ", WHITE, "Scanning for alpha..."),
        full_border("╠", "╣"),
...
def gen_copy():
    ...
    lines = [
        ...
        full_border("╠", "╣", "╧"),
        smart_log("09:31:02", "INFO ", WHITE, "COPY TRADING STARTING..."),
        smart_log("09:31:03", "CONN ", GREEN, "CONNECTED | Lead: Apex"),
        smart_log("09:31:03", "CONN ", GREEN, "CONNECTED | Follower: TopStep"),
        smart_log("09:31:04", "INFO ", WHITE, "COPY READY | MNQ Mar25 | Ratio 1:1"),
        smart_log("09:32:15", "SYS  ", CYAN, "▲ LONG | Lead buying..."),
        smart_log("09:32:16", "BUY  ", GREEN, "LEAD ✓ FILLED | BUY 1 MNQ @ 21,845.25"),
        smart_log("09:32:16", "BUY  ", GREEN, "COPY ✓ FILLED | BUY 1 MNQ @ 21,845.50 | slip: 0.25"),
        smart_log("09:33:42", "SYS  ", CYAN, "▼ SHORT | Lead closing..."),
        smart_log("09:33:42", "SELL ", RED, "LEAD ✓ FILLED | SELL 1 MNQ @ 21,860.50"),
        smart_log("09:33:42", "SELL ", RED, "COPY ✓ FILLED | SELL 1 MNQ @ 21,860.25 | slip: 0.25"),
        smart_log("09:33:43", "WIN  ", GREEN, "POSITION CLOSED | Lead: +$30.50 | Copy: +$29.50"),
        smart_log("09:34:55", "BUY  ", GREEN, "LEAD ✓ FILLED | BUY 1 MNQ @ 21,855.00"),
        smart_log("09:34:55", "BUY  ", GREEN, "COPY ✓ FILLED | BUY 1 MNQ @ 21,855.00 | no slip"),
        smart_log("09:35:38", "WIN  ", GREEN, "POSITION CLOSED | Lead: +$33.00 | Copy: +$32.50"),
        smart_log("09:35:50", "INFO ", WHITE, "Awaiting lead signal..."),
        full_border("╠", "╣"),
        center_line([("Press ", WHITE), ("[X]", RED), (" to stop trading", WHITE)]),
        full_border("╚", "╝"),
    ]
